  function wireSearch(p){
    ...
    async function run(){const s=q.value.trim();if(!s){body.innerHTML='<div class="qempty">Type to search notes · tasks · reminders · research.</div>';return}
      ...
      const MAP={notes:'notes',tasks:'tasks',reminders:'reminders',research:'research'};
